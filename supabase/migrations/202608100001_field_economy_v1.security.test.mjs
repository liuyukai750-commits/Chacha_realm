...
test("定位与五秒阅读边界只能经 Next 服务端进入 privileged RPC", () => {
  ...
  assert.match(repository, /serviceRpc<Omit<CreateMelonResult, "cityId">>\(\s*"create_melon"[\s\S]*p_actor_id: actorId/i);
  assert.match(repository, /p_city_id: spot\.cityId/i);
